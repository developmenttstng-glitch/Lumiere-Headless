...
// Customer Account API graphql endpoint — discovered dynamically
...
export function useCustomer() {
  ...
  const handleCallback = useCallback(async () => {
    ...
    // Already logged in — back button case
    ...
    try {
      ...
      // Get customer profile from Customer Account API
  ...
  return { customer: resolvedCustomer, token: resolvedToken, isLoggedIn, loading, error, setError, login, logout, handleCallback, fetchOrders }
}
